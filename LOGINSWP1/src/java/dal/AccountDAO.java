...
public void addAccount(Accounts account) {
    try {
        String query = "INSERT INTO Accounts (fullName, email, password, gender, address, phone, userImage, lastLogin, createDate, status) "
                     + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        ps.setBoolean(4, account.getGender());
        ps.setString(5, account.getAddress());
        ps.setString(6, account.getPhone());
        ps.setString(7, account.getUserImage());
        ps.setDate(8, account.getLastLogin());
        ps.setDate(9, account.getCreateDate());
        ps.setInt(10, account.getStatus());
